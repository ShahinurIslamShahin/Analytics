...
WHENEVER SQLERROR EXIT SQL.SQLCODE
    ...
    SELECT '$2',MSISDN,SUBSTR(G379_CALLINGCELLID,16,30) AS G379_CALLINGCELLID,LCOUNT,G383_CHARGINGTIME_HOUR
    FROM
    (
    SELECT '$2', A.MSISDN,LPAD(A.G379_CALLINGCELLID,30,0) AS G379_CALLINGCELLID, LCOUNT,B.G383_CHARGINGTIME_HOUR
    FROM MSISDN_DATA_FOR_SYSDATE_1_LD A, L3_DATA PARTITION ($1) B
    WHERE A.DATE_KEY =$2
    AND B.G383_CHARGINGTIME_KEY = $2
