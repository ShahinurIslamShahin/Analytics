...
PACKAGE_WISE_VOICE_PROFIT_SYS2()
{
sqlplus  -s <<EOF
dwh_user/dwh_user_123
SET echo off
...
SET feedback off
REM "WHENEVER SQLERROR EXIT SQL.SQLCODE"
alter table PACKAGE_WISE_VOICE_PROFIT truncate partition $1;
EXECUTE R_PACKAGE_WISE_VOICE_PROFIT_SYS2;
EXIT
EOF
}
PACKAGE_WISE_VOICE_PROFIT_SYS2 $partition
echo "$1"
