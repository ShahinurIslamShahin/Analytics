...
SUBSCRIBER_USAGE_ANALYSIS_SYS2()
{
sqlplus  -s <<EOF
dwh_user/dwh_user_123
SET echo off
...
SET feedback off
REM "WHENEVER SQLERROR EXIT SQL.SQLCODE"
alter table SUBSCRIBER_USAGE_ANALYSIS truncate partition $1;
EXECUTE R_SUBSCRIBER_USAGE_ANALYSIS_SYS2;
EXIT
EOF
}
SUBSCRIBER_USAGE_ANALYSIS_SYS2 $partition
echo "$1"
