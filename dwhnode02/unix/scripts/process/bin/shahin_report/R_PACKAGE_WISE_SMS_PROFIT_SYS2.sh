...
SET feedback off
REM "WHENEVER SQLERROR EXIT SQL.SQLCODE"
alter table PACKAGE_WISE_SMS_PROFIT truncate partition $1;
EXECUTE R_PACKAGE_WISE_SMS_PROFIT_SYS2;
EXIT
EOF
}
PACKAGE_WISE_SMS_PROFIT $partition
echo "$1"
