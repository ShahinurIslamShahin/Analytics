--
-- R_SUBSCRIBER_CREDIT_SCORE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R_SUBSCRIBER_CREDIT_SCORE IS
    VDATE_KEY       NUMBER;
BEGIN
...
WHERE MONTH_KEY =(SELECT  MONTH_KEY FROM DATE_DIM P WHERE  DATE_VALUE= TRUNC(TO_DATE(SYSDATE,'DD/MM/RRRR')))-1
