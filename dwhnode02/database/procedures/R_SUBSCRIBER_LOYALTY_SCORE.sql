--
-- R_SUBSCRIBER_LOYALTY_SCORE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R_SUBSCRIBER_LOYALTY_SCORE IS
    VDATE_KEY       NUMBER;
BEGIN
...
DELETE SUBSCRIBER_LOYALTY_SCORE WHERE LOYALTY_QUARTER=(SELECT DISTINCT QUARTER
FROM
(SELECT
CASE
...
INSERT INTO SUBSCRIBER_LOYALTY_SCORE
