--
-- R22_REPEAT_BOTH_VOICE_SMS_USERS  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R22_REPEAT_BOTH_VOICE_SMS_USERS IS
    VDATE_KEY       NUMBER;
BEGIN
...
INSERT INTO REPEAT_BOTH_VOICE_SMS_USERS
...
GROUP BY S372_CALLINGPARTYNUMBER) Q ON S372_CALLINGPARTYNUMBER=V372_CALLINGPARTYNUMBER 
