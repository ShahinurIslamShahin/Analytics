--
-- P_LAST_ACTIVITY_FCT_LD_PART2_240420  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_LAST_ACTIVITY_FCT_LD_PART2_240420 IS
    VDATE_KEY               NUMBER;
...
--=================================LU_DATE_KEY,LU_TIME_KEY===============--
    ...
    FROM 
    LAST_ACTIVITY_FCT_LD
    WHERE SNAPSHOT_DATE_KEY=VDATE_KEY
    UNION ALL
    SELECT MSISDN,
    ...
    FROM 
    LAST_ACTIVITY_FCT_LD
    WHERE SNAPSHOT_DATE_KEY=VDATE_KEY)A
