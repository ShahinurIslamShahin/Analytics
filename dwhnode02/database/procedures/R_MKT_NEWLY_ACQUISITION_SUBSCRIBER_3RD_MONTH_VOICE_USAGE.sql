--
-- R_MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_VOICE_USAGE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R_MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_VOICE_USAGE IS
...
DELETE MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_VOICE_USAGE WHERE DATE_KEY=VDATE_KEY;
COMMIT;
    
INSERT INTO MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_VOICE_USAGE

SELECT /*+PARALLEL(P,14)*/ V372_CALLINGPARTYNUMBER, V397_MAINOFFERINGID,SUM( V35_RATE_USAGE)/60 THIRD_MONTH_VOICE ,VDATE_KEY
FROM L3_VOICE P
