--
-- R_MKT_DATA_REVENUE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R_MKT_DATA_REVENUE IS
    VDATE_KEY       NUMBER;
BEGIN
...
FROM L3_RECURRING Q
WHERE R377_CYCLEBEGINTIME_KEY = TO_CHAR((SELECT DATE_KEY FROM DATE_DIM WHERE DATE_VALUE = TO_DATE(sysdate-1,'DD/MM/RRRR')))
