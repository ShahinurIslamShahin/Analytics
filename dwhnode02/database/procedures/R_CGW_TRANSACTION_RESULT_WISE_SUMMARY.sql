--
-- R_CGW_TRANSACTION_RESULT_WISE_SUMMARY  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R_CGW_TRANSACTION_RESULT_WISE_SUMMARY IS
...
DELETE CGW_TRANSACTION_RESULT_WISE_SUMMARY WHERE DATE_KEY=VDATE_KEY;
COMMIT;
    
INSERT INTO CGW_TRANSACTION_RESULT_WISE_SUMMARY



SELECT CGW10_RESULT_CODE,TRANSACTION_RESULT,SUM(TRANSACTION_COUNT) TRANSACTION_COUNT,SUM(CGW14_AMOUNT) CGW14_AMOUNT,VDATE_KEY
FROM
