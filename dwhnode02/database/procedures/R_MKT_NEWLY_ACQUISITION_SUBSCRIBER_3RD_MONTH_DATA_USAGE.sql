--
-- R_MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_DATA_USAGE  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R_MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_DATA_USAGE IS
...
DELETE MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_DATA_USAGE WHERE DATE_KEY=VDATE_KEY;
COMMIT;
    
INSERT INTO MKT_NEWLY_ACQUISITION_SUBSCRIBER_3RD_MONTH_DATA_USAGE

SELECT /*+PARALLEL(P,14)*/ G372_CALLINGPARTYNUMBER, G401_MAINOFFERINGID,SUM(G384_TOTALFLUX)/1048576 THIRD_MONTH_DATA ,VDATE_KEY
FROM L3_dATA P
