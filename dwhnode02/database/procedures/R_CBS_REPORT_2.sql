--
-- R_CBS_REPORT_2  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.R_CBS_REPORT_2 IS
    VDATE_KEY       NUMBER;
BEGIN
...
WHERE G383_CHARGINGTIME_KEY  = TO_CHAR((SELECT DATE_KEY FROM DATE_DIM WHERE DATE_VALUE = TRUNC(TO_DATE(sysdate-1,'DD/MM/RRRR'))))
...
WHERE S387_CHARGINGTIME_KEY  =TO_CHAR((SELECT DATE_KEY FROM DATE_DIM WHERE DATE_VALUE = TRUNC(TO_DATE(sysdate-1,'DD/MM/RRRR'))))
...
WHERE RE30_ENTRY_DATE_KEY = TO_CHAR((SELECT DATE_KEY FROM DATE_DIM  WHERE DATE_VALUE = TO_DATE(sysdate-1,'DD/MM/RRRR')))
