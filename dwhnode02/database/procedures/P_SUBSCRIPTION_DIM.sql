--
-- P_SUBSCRIPTION_DIM  (Procedure) 
--
CREATE OR REPLACE PROCEDURE DWH_USER.P_SUBSCRIPTION_DIM IS
...
*/
    ...
    WHERE A22_ENTRY_DATE_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    and A.A463_PAYTYPE = B.PAY_TYPE_ID
    ...
    WHERE CO402_STARTTIMEOFBILLCYL_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    and A.CO410_PAYTYPE = B.PAY_TYPE_ID
    ...
    WHERE M378_STARTTIMEOFBILLCYCLE_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    and A.M377_PAYTYPE = B.PAY_TYPE_ID
    ...
    WHERE R377_CYCLEBEGINTIME_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    AND A.R374_PAYTYPE = B.PAY_TYPE_ID
    ...
    WHERE S387_CHARGINGTIME_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    AND A.S398_PAYTYPE = B.PAY_TYPE_ID
    ...
    WHERE T29_ENTRY_DATE_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    AND A.T459_PAYTYPE = B.PAY_TYPE_ID
    ...
    WHERE V387_CHARGINGTIME_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    AND A.V400_PAYTYPE = B.PAY_TYPE_ID
    ...
    AND A.RE490_PAYTYPE = B.PAY_TYPE_ID
    ...
    WHERE G383_CHARGINGTIME_KEY=(SELECT DATE_KEY FROM DATE_DIM WHERE TO_CHAR(DATE_VALUE,'RRRRMMDD')=TO_CHAR(SYSDATE-1,'RRRRMMDD'))
    AND A.G403_PAYTYPE = B.PAY_TYPE_ID
