...
REPEAT_ALL_VOICE_DATA_SMS_USERS()
{
sqlplus  -s <<EOF
dwh_user/dwh_user_123
SET echo off
...
SET feedback off
REM "WHENEVER SQLERROR EXIT SQL.SQLCODE"
alter table REPEAT_ALL_VOICE_DATA_SMS_USERS truncate partition $1;
EXECUTE R_REPEAT_ALL_VOICE_DATA_SMS_USERS;
EXIT
EOF
}
REPEAT_ALL_VOICE_DATA_SMS_USERS $partition
echo "$1"
