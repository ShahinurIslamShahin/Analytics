...
DELETE CBS_REPORT_2 WHERE DATE_KEY='$v6';
COMMIT;
...
SELECT DATE_VALUE,AGAMI_TK,BORNOMALA_TK,CORPORATE_TK,MAYERHASHI_TK,OPORAJITA_TK,PCO_TK,PROJONMO_TK,SAGOTOM_TK,SHADHEEN_TK,YOUTH3G_TK,YOUTHDF_TK,YOUTHRC_TK,YOUTH_TK, 
       TOTAL_VOICE_TK,TOTAL_DATA_TK,TOTAL_SMS_TK,DATA_PPU_REVENUE,BUNDLE_REVENUE,TOTAL_COMBO,EXCLUSIVE_DATA_PACK,REGULAR_DATA_PACK,OTHER_DATA_PACK,TOTAL_REVNUE_TK,RECHARGE_AMOUNT,'$v6'
FROM DATE_DIM AA,
...
lock=/data02/scripts/process/bin/CBS_REPORT_2  export lock
