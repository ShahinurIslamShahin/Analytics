...
SET feedback off
REM "WHENEVER SQLERROR EXIT SQL.SQLCODE"
alter table REPEAT_BOTH_DATA_SMS_USERS truncate partition $1;
EXECUTE R_REPEAT_BOTH_DATA_SMS_USERS;
EXIT
EOF
}
REPEAT_BOTH_DATA_SMS_USERS $partition
echo "$1"
