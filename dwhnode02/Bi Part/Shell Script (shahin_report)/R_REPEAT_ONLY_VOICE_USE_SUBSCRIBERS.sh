...
REPEAT_ONLY_VOICE_USE_SUBSCRIBERS()
{
sqlplus  -s <<EOF
dwh_user/dwh_user_123
SET echo off
...
SET feedback off
REM "WHENEVER SQLERROR EXIT SQL.SQLCODE"
alter table REPEAT_ONLY_VOICE_USE_SUBSCRIBERS truncate partition $1;
EXECUTE R_REPEAT_ONLY_VOICE_USE_SUBSCRIBERS;
EXIT
EOF
}
REPEAT_ONLY_VOICE_USE_SUBSCRIBERS $partition
echo "$1"
